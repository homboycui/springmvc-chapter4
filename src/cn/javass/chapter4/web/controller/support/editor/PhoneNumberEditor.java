...
public class PhoneNumberEditor extends PropertyEditorSupport {
	...
	/**
	 *@author cfl
	 *@createTime 18-2-22 上午11:04
	 *@description 表示将String——>PhoneNumberModel，根据正则表达式进行转换，如果转换失败抛出异常，则接下来的验证器会进行验证处理。
	 *@params [text]
	 *@return void
	 */
	@Override
	...
	/**
	 *@author cfl
	 *@createTime 18-2-22 上午11:05
	 *@description 表示将PhoneNumberModel——>String。
	 *@params []
